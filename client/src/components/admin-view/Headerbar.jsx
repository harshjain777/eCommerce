  ...
  return (
    <header className='flex items-center justify-between px-4 py-3  border-b border[1px] border-zinc-300'>
      ...
      <div className="flex flex-1 justify-end ">
        <Button className=' inline-flex  hover:bg-zinc-200 hover:text-black items-center  gap-2 text-sm font-light px-4 py-2 tracking-tight rounded-md'><div className="hidden lg:block">Logout</div><LogOut /> </Button>
      </div>
